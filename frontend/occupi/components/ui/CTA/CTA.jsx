                    ...
                    <div className="relative z-10">
                        <div className="max-w-xl mx-auto text-center">
                            <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                                Unleash the Power of AI with Office Analytics
                            </h2>
                            <p className="mt-5 text-gray-300">
                                occupi is the perfect answer! Our AI-based capacity prediction platform enables you to create highly targeted email campaigns that are tailored to each individual subscriber.
                            </p>
                        </div>
