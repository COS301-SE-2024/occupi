      ...
      <div className="flex relative">
        ...
        >
          <div className="menu p-4 w-80 bg-base-100 text-base-content bg-transparent">
              ...
              <MenuItem icon={<Privacy />} selectedItem={selectedItem} text="Notifications" path="/notifications" handleClick={handleClick} />
              <MenuItem icon={<AlertIcon />} selectedItem={selectedItem} text="Security" path="/security" handleClick={handleClick} />
