...
const BookRoom = () => {
  ...
  useEffect(() => {
    ...
    fetchAllRooms();
  }, []); //<---- this create an infinite loop [toast]
  ...
  return (
    <View style={{ flex: 1, backgroundColor, paddingTop: 60 }}>
      <View style={{ flexDirection: "column", backgroundColor }}>
        ...
        >
          <Text testID="book-header" style={{ fontWeight: 'bold', fontSize: 24, color: textColor }}>Book</Text>
        </View>
        <View
          style={{
            marginHorizontal: 16,
        ...
        >
          <Text style={{ fontSize: wp("4%"), color: textColor }}>
        ...
        >
          ...
          <TouchableOpacity onPress={toggleLayout} testID="layout-toggle">
            {layout === "row" ? (
              <View testID="row-layout">
                <Ionicons name="grid-outline" size={22} color="#2C2C2E" />
              </View>
            ) : (
              <View testID="grid-layout">
              ...
              {pair.map((room, idx) => (
                ...
                >
                  <Image
                    ...
                    source={{
                      uri: "https://content-files.shure.com/OriginFiles/BlogPosts/best-layouts-for-conference-rooms/img5.png",
                    }}
                  />
                  <View style={{ padding: 10 }}>
                    ...
                    >
                      ...
                      >
                        <Text style={{ color: "dimgrey", fontSize: 13 }}>
                          Available: now
                        </Text>
                      </TouchableOpacity>
                      <Ionicons
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text style={{ bottom: 0, color: "dimgrey", fontSize: 13 }}>
                      Available: now
                    </Text>
                  </TouchableOpacity>
                  <Ionicons
