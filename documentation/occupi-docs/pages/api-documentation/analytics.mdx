...
```
/analytics/user-arrival-departure-average?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
...
```
/analytics/user-in-office-rate?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
...
```
/analytics/work-ratio?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
...
```
/analytics/peak-office-hours?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
...
```
/analytics/arrival-departure-average?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
...
```
/analytics/in-office-rate?email=abcd@gmail&timeFrom=2021-01-01T00json&timeTo=2021-01-01T00:00:00.000Z&limit=50&page=1
```
